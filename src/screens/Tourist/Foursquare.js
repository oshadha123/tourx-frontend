      ...
      const render = () => (
        <ScrollView>
          <Card style={styles.cardContainer} mode="outlined">
            ...
            <Card.Content>
              <Title>
                <Paragraph style={{ fontSize: 20, fontWeight: "bold" }}>{data['results'][i]['name']}</Paragraph>
              </Title>
              <Title>
          ...
          <Card style={styles.cardContainer} mode="outlined">
            ...
            <Card.Content>
              <Title>
                <Paragraph style={{ fontSize: 20, fontWeight: "bold" }}>{data['results'][j]['name']}</Paragraph>
              </Title>
              <Title>
          ...
          <Card style={styles.cardContainer} mode="outlined">
            ...
            <Card.Content>
              <Title>
                <Paragraph style={{ fontSize: 20, fontWeight: "bold" }}>{data['results'][k]['name']}</Paragraph>
              </Title>
              <Title>
          ...
          <Card style={styles.cardContainer} mode="outlined">
            ...
            <Card.Content>
              <Title>
                <Paragraph style={{ fontSize: 20, fontWeight: "bold" }}>{data['results'][p]['name']}</Paragraph>
              </Title>
              <Title>
          ...
          <Card style={styles.cardContainer} mode="outlined">
            ...
            <Card.Content>
              <Title>
                <Paragraph style={{ fontSize: 20, fontWeight: "bold" }}>{data['results'][w]['name']}</Paragraph>
              </Title>
              <Title>
          ...
          <Card style={styles.cardContainer} mode="outlined">
            ...
            <Card.Content>
              <Title>
                <Paragraph style={{ fontSize: 20, fontWeight: "bold" }}>{data['results'][t]['name']}</Paragraph>
              </Title>
              <Title>
              ...
              <Button icon="map" mode="contained" onPress={() => navigation.navigate('MapView6', {
